import { Shield, Upload, Cpu, BarChart3, Camera, Link2 } from "lucide-react";
...
const features = [
  ...
  { icon: Link2, title: "Video URL", desc: "Analyze any video stream by URL" },
...
export function HeroSection({ onGetStarted, onLiveDetection, onUrlAnalysis }: HeroSectionProps) {
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center px-4">
      ...
      <div className="relative z-10 text-center max-w-3xl">
        ...
        <p className="text-lg md:text-xl text-muted-foreground mb-10 max-w-xl mx-auto leading-relaxed">
          AI-powered deepfake detection. Upload a video, use your webcam, or analyze a video stream by URL.
        </p>
